...
class ChangeTextTest {
    ...
    private val textEmpty1 = ""
    private val textEmpty2 = "     "
...
//    }
    ...
    fun testEmptyString() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = textToSet
        device.findObject(By.res(packageName, "buttonChange")).click()
        device.findObject(By.res(packageName, "userInput")).text = textEmpty1
        device.findObject(By.res(packageName, "buttonChange")).click()
    ...
    fun testSpaceString() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = textEmpty2
        device.findObject(By.res(packageName, "buttonChange")).click()
